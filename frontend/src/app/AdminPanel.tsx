...
import { Flag, RefreshCw, Shield, ShieldCheck, Star, Trash2, UserPlus, Users } from 'lucide-react';
...
type Tab = 'products' | 'users' | 'admins' | 'reports' | 'reviews';
